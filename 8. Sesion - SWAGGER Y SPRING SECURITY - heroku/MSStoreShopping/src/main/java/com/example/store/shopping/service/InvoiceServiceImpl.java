...
public class InvoiceServiceImpl implements InvoiceService {
	...
	@HystrixCommand(fallbackMethod = "defaultfindInvoiceAll", commandProperties = {
			...
			//es una propiedad que establece el número mínimo de solicitudes en una ventana móvil que disparará el circuito y su valor 
			//predeterminado es 20 y su valor se puede cambiar en el archivo de propiedades o en nuestro @HystrixCommandmétodo anotado.
			@HystrixProperty(name = "metrics.rollingStats.timeInMilliseconds", value = "500"),
			//El período de tiempo de la ventana inactiva establece la cantidad de tiempo, después de disparar el circuito, para rechazar las 
			//solicitudes antes de permitir intentos nuevamente para determinar si el circuito debe cerrarse nuevamente. Su valor está predeterminado en 5000 milisegundos. 
